...
def  nba_basketballreference_scraper(request):
    ...
    try:
        ...
        return 'Successfully loaded {} row(s) to raw_basketballreference_playerbox and {} to raw_basketballreference_game'.format(player_game_rows_loaded,game_rows_loaded)
